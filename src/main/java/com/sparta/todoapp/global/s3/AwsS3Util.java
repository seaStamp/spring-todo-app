package com.sparta.todoapp.global.s3;

import com.amazonaws.services.s3.AmazonS3;
import com.amazonaws.services.s3.model.ObjectMetadata;
import com.sparta.todoapp.global.s3.exception.AwsS3ErrorCode;
import com.sparta.todoapp.global.s3.exception.AwsS3InternalException;
import com.sparta.todoapp.global.s3.exception.FileTypeNotAllowedException;
import com.sparta.todoapp.global.s3.exception.NotFoundS3FileException;
...
public class AwsS3Util {
    ...
    public void deleteImage(String fileName) {
        if (fileName.isEmpty()
            || !amazonS3.doesObjectExist(bucketName, fileName)) {
